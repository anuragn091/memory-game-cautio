...
export default function UserDashboard({
  ...
  const Stats = () => {
    return (
      <div
        className={`p-4 rounded-lg border ${getConditionalClasses(
          darkMode,
      ...
      >
        <h3
          className={`text-lg font-semibold mb-3 ${getConditionalClasses(
            darkMode,
            themeClasses.text.primary.light,
            themeClasses.text.primary.dark
          )}`}
  ...
  const StartNewGame = () => {
    return (
      ...
      >
        ...
        <p
          className={`text-sm mb-4 ${getConditionalClasses(
            darkMode,
            themeClasses.text.secondary.light,
            themeClasses.text.secondary.dark
          )}`}
          ...
          {userData.sessions
            ...
            .map((session) => (
              <div
                ...
                className={`p-3 rounded border ${getConditionalClasses(
                  darkMode,
              ...
              >
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`font-medium ${getConditionalClasses(
                        darkMode,
                        themeClasses.text.primary.light,
                        themeClasses.text.primary.dark
                      )}`}
                    ...
                    <span
                      className={`text-sm ${getStatusColor(session.status)}`}
                    >
                      {session.status}
                    </span>
                  </div>
                  <div className="text-right">
                    ...
                    {session.duration && (
                      <div
                        className={`text-sm font-medium ${getConditionalClasses(
                          darkMode,
                          themeClasses.text.primary.light,
                          themeClasses.text.primary.dark
                        )}`}
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="space-y-6">
        ...
        {/* Previous Sessions */}
        {userData.sessions.length > 0 && <PreviousSessions />}
      </div>
    </div>
  );
}
