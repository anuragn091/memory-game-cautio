...
export default function TileComponent({ tile, onClick, index, darkMode }: Props) {
  ...
  const base = `${themeClasses.tile.base} ${getConditionalClasses(darkMode, themeClasses.tile.border.light, themeClasses.tile.border.dark)}`;
  
  let bg = '';
  if (tile.isMatched) {
    bg = getConditionalClasses(darkMode, themeClasses.tile.background.matched.light, themeClasses.tile.background.matched.dark);
  } else if (tile.isFlipped) {
    bg = getConditionalClasses(darkMode, themeClasses.tile.background.flipped.light, themeClasses.tile.background.flipped.dark);
  } else {
    bg = getConditionalClasses(darkMode, themeClasses.tile.background.default.light, themeClasses.tile.background.default.dark);
  }
